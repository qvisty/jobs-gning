...
export const events = [
  ...
  },
  {
    ...
    tag: 'frist',
    tagLabel: 'Frist · overvejes',
    heading: 'Afdelingsleder, udskoling · Kongehøjskolen',
    headingUrl: 'kongehoejskolen.html',
    desc: 'Aabenraa Kommune. Sikkerhedsnet under Hærvejsskolen. Send ansøgning, CV og bilag senest tirsdag den 20. oktober, helst søndag den 18.',
    calTitle: 'Ansøgningsfrist: Afdelingsleder · Kongehøjskolen',
    calDesc: 'Send ansøgning, CV og bilag senest tirsdag den 20. oktober.',
    calUrl: 'kongehoejskolen.html',
  },
  {
    start: '2026-10-21',
    kind: 'samtale',
    abbr: 'K',
    tag: 'samtale',
    tagLabel: 'Beslutning om indkaldelse',
    heading: 'Indkaldelse afgøres · Kongehøjskolen',
    headingUrl: 'kongehoejskolen.html',
    desc: 'Ansættelsesudvalget beslutter, hvem der indkaldes til 1. samtale den 27. oktober.',
    calTitle: 'Beslutning om indkaldelse: Kongehøjskolen',
    calDesc: 'Ansættelsesudvalget beslutter, hvem der indkaldes til første samtale.',
    calUrl: 'kongehoejskolen.html',
  },
  {
    start: '2026-10-27',
    ...
    abbr: 'K',
    tag: 'samtale',
    tagLabel: '1. samtale · dagen før Hærvejs 2.',
    heading: 'Afdelingsleder, udskoling · Kongehøjskolen',
    headingUrl: 'kongehoejskolen.html',
    desc: 'Første samtalerunde med et panel på elleve. Dagen før Hærvejsskolens 2. samtale, så forberedelsen skal ligge den 26.',
    calTitle: '1. samtale: Afdelingsleder · Kongehøjskolen',
    calDesc: 'Første samtalerunde. Panel på elleve personer.',
    calUrl: 'kongehoejskolen.html',
  },
  {
    start: '2026-11-12',
    ...
    abbr: 'K',
    tag: 'samtale',
    tagLabel: '2. samtale · case og personprofil',
    heading: 'Afdelingsleder, udskoling · Kongehøjskolen',
    headingUrl: 'kongehoejskolen.html',
    desc: 'Anden samtalerunde med fremlæggelse af udsendt case og tilbagemelding på personprofil. Ligger efter Hærvejsskolens afgørelse.',
    calTitle: '2. samtale: Afdelingsleder · Kongehøjskolen (case)',
    calDesc: 'Anden samtalerunde. Case udsendt på forhånd, personprofil-tilbagemelding forinden.',
    calUrl: 'kongehoejskolen.html',
  },
  {
    start: '2027-01-01',
    ...
    heading: 'Afdelingsleder, udskoling · Kongehøjskolen',
    headingUrl: 'kongehoejskolen.html',
    desc: 'Forventet tiltrædelse 1. januar 2027.',
    calTitle: 'Tiltrædelse: Afdelingsleder · Kongehøjskolen',
